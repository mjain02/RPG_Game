...
/**
Add an obstacle for the sprite
*/
void add_rock(int x, int y);

/**
Add a door for the second map
*/
void add_door(int x, int y);

/**
Add a key for the second map
*/
void add_key(int x, int y);

/**
Add a monster for the second map
*/
void add_monster(int x, int y);

/**
Add the main exit to end the quest
*/
void add_exit(int x, int y);

/**
Add the water spell symbol to end the quest
*/
void add_waterspell(int x, int y);

/**
Add the fire spell symbol to end the quest
*/
